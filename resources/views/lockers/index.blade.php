    ...
    <div class="mx-auto max-w-6xl space-y-6 bg-[#F8F9FA]">
        ...
        <section class=" bg-[#1E3A8A] px-6 py-5 text-white  rounded-lg  shadow-md sm:px-8">
            <div class="flex items-center gap-3 sm:justify-between">
                ...
                <a href="/lockers/create" class="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-[#111827] shadow-sm hover:bg-[#C7D2EF] ">
        ...
        <section class=" grid gap-8 sm:grid-cols-3">
            ...
            <div>
                <div class=" bg-white px-5 py-5 rounded-lg border border-slate-200 shadow-sm ">
                    <div class="flex items-center justify-between">
                        <p class="text-base text-slate-600 ">Free lockers</p>
            ...
            <div>
                <div class=" bg-white px-5 py-5 rounded-lg border border-slate-200 shadow-sm ">
                    <div class="flex items-center justify-between">
                        <p class="text-base text-slate-600 ">In need of attention</p>
                        <i class="fa-solid fa-box text-blue-700" aria-hidden="true"></i>
                    </div>
                ...
                <table class="w-full min-w-[640px] text-left text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr class="text-slate-700 transition-colors hover:bg-slate-50">
                            <td class="px-5 py-4 font-medium text-slate-900">#001</td>
                            <td class="px-5 py-4">Small</td>
                            <td class="px-5 py-4">
                                <span class="status-available rounded-full px-2.5 py-1 text-xs font-semibold">Available</span>
                            </td>
                            <td class="px-5 py-4 text-right">
                                <a href="{{ route('lockers.show') }}" title="View locker" aria-label="View locker 001" class="mr-3 text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('lockers.edit') }}" title="Edit locker" aria-label="Edit locker 001" class="text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-pen-to-square" aria-hidden="true"></i>
                                </a>
                            </td>
                        </tr>
                        <tr class="text-slate-700 transition-colors hover:bg-slate-50">
                            <td class="px-5 py-4 font-medium text-slate-900">#002</td>
                            <td class="px-5 py-4">Medium</td>
                            <td class="px-5 py-4">
                                <span class="status-in-use rounded-full px-2.5 py-1 text-xs font-semibold">In use</span>
                            </td>
                            <td class="px-5 py-4 text-right">
                                <a href="{{ route('lockers.show') }}" title="View locker" aria-label="View locker 002" class="mr-3 text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('lockers.edit') }}" title="Edit locker" aria-label="Edit locker 002" class="text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-pen-to-square" aria-hidden="true"></i>
                                </a>
                            </td>
                        </tr>
                        <tr class="text-slate-700 transition-colors hover:bg-slate-50">
                            <td class="px-5 py-4 font-medium text-slate-900">#003</td>
                            <td class="px-5 py-4">Large</td>
                            <td class="px-5 py-4">
                                <span class="status-maintenance rounded-full px-2.5 py-1 text-xs font-semibold">Maintenance</span>
                            </td>
                            <td class="px-5 py-4 text-right">
                                <a href="{{ route('lockers.show') }}" title="View locker" aria-label="View locker 003" class="mr-3 text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('lockers.edit') }}" title="Edit locker" aria-label="Edit locker 003" class="text-slate-400 transition hover:text-blue-700">
                                    <i class="fa-solid fa-pen-to-square" aria-hidden="true"></i>
                                </a>
                            </td>
                        </tr>
